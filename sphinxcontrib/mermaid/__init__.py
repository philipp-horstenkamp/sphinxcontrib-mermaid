...
def install_js(
    ...
    _mermaid_iconify_json_url = None
    if app.config.mermaid_include_iconify:
        if app.config.mermaid_iconify_use_local:
            _mermaid_iconify_json_url = app.config.mermaid_iconify_use_local
        elif app.config.mermaid_iconify_version == "latest":
            _mermaid_iconify_json_url = (
                f"https://cdn.jsdelivr.net/npm/@iconify-json/{app.config.mermaid_iconify_iconset}/icons.json"
            )
        elif app.config.mermaid_iconify_version:
            _mermaid_iconify_json_url = (
                f"https://cdn.jsdelivr.net/npm/@iconify-json/{app.config.mermaid_iconify_iconset}@{app.config.mermaid_iconify_version}/icons.json"
            )
    ...
    common_render_args = dict(
        ...
        mermaid_include_iconify=_mermaid_iconify_json_url is not None,
        mermaid_elk_js_url=_mermaid_elk_js_url,
        mermaid_zenuml_js_url=_mermaid_zenuml_js_url,
        mermaid_iconify_json_url=_mermaid_iconify_json_url,
...
def setup(app):
    ...
    app.add_config_value("mermaid_include_iconify", False, "html")
    ...
    app.add_config_value("mermaid_iconify_iconset", "logos", "html")
